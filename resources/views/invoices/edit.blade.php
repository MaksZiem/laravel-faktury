...
@section('content')
        ...
        <section class="masthead page-section" id="contact">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">edytujesz fakrture {{ $invoice->id }}</h2>
                <!-- Icon Divider-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form  action="{{ route('invoices.update', ['id' => $invoice->id]) }}" method="post" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <!-- Submit Button-->
                            <button class="btn btn-primary btn-xl " id="submitButton" type="submit">Zapisz fakture</button>
                        </form>
                    </div>
                </div>
            </div>
