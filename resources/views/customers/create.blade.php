                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form  action="{{ route('customers.store') }}" method="POST" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="name" type="text" name="name" placeholder="nazwa" data-sb-validations="required" />
                                <label for="name">Nazwa klienta</label>
                                <!-- <div class="invalid-feedback" data-sb-feedback="name:required">A name is required.</div> -->
                            </div>
                            <!-- Email address input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="adres" name="adres" type="text" placeholder="adres klienta" data-sb-validations="required" />
