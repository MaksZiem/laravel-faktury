...
@section('content')
        ...
        <section class="masthead page-section" id="contact">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">edytujesz fakrture {{ $customer->id }}</h2>
                <!-- Icon Divider-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form  action="{{ route('customers.update', ['klienci' => $customer->id]) }}" method="post" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <!-- Email address input-->
                            <div class="form-floating mb-3">
                                <input value="{{ $customer->adres }}" class="form-control" id="adres" name="adres" type="text" placeholder="adres klienta" data-sb-validations="required" />
